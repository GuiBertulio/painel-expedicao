...
# Função separada para carregar a aba de Drill-Down Diário
...
# Dispara as funções para encher a memória do site
df = carregar_dados()
        ...
        if not dados_pessoa.empty:
            ...
            if grafico_dados:
                ...
                with col_tabela:
                    ...
                    # =============================================================================
                    # 📅 DRILL-DOWN DIÁRIO (Exclusivo para T3 Separador)
                    # =============================================================================
                    if turno_p == "T3" and "SEPARADOR" in cargo_p:
                        if not df_diario.empty:
                            ...
                            if not df_pessoa_diario.empty:
                                ...
                                # Caça as datas brutas no cabeçalho do arquivo Diário
                                ...
                                if cols_datas_reais:
                                    ...
                                    # Baseado no dia escolhido, cruza para achar a coluna da planilha
                                    ...
                                    # Limpeza rápida contra células vazias (Nan, None)
                                    ...
                                    # Constrói o visual das métricas diárias
                    ...
                    # =============================================================================
                    # TABELA NORMAL INDIVIDUAL (Se NÃO for o T3 Separador)
                    # =============================================================================
                    else:
                        kpis_ativos_pessoa = []
