...
# ==========================================
# CONEXÃO COM GOOGLE SHEETS (BANCO DE DADOS RH)
# ==========================================
...
def carregar_dados():
    ...
    # 🔥 SUPER AUTO-CORRETOR À PROVA DE BALAS
    for c in list(df.columns):
        nome_limpo = c.strip().upper()
        # Aceita "Palet" ou "Pallet", com ou sem a palavra "Conf"
...
try:
    ...
    with col_kpis:
        ...
        # --- LÓGICA INTELIGENTE PARA O VOLUME DO TOPO ---
        ...
        # --- LÓGICA INTELIGENTE PARA A VELOCIDADE ---
        if turno_selecionado == 'T1' or (cargo_selecionado != "Todos" and cargo_selecionado in ['OPERADOR', 'DESCARGA', 'PUXA']):
