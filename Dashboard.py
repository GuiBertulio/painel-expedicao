...
# (Removido: Avaria, Corte e Devolução por serem manuais)
# ==========================================
metas_100 = {
    'T3': {
        'SEPARADOR F': {
            ...
            if metas_cargo:
                ...
                for idx, (ind, regra) in enumerate(metas_cargo.items()):
                    if ind in dados_pessoa.columns:
                        ...
                        html_dinheiro = f'<span style="color: {C_VERDE}; font-size: 20px; font-weight: 900;">💰 {texto_grana}</span>' if pagamento_ind > 0 else ""
